...
export const metadata: Metadata = {
  ...
  description: "Free financial calculators for SIP, FD, EMI, income tax and 30+ tools. Plan your financial future with India's most accurate calculator platform.",
};
